...
const data = {
    ...
    "price": 1500,
    "description": "Console Videogames",
    "categoryId": 1,
    "images": ["https://placeimg.com/640/480/any"]
  };

  //podemos usar el postData como una promesa y con .then obtener la respuesta como un objeto json y mostrarlo después en la consola//podemos usar el postData como una promesa y con .then obtener la respuesta como un objeto json y mostrarlo después en la consola
